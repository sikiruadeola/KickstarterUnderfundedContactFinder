 ...
 *
 * Reused unchanged from the YouTube Creator Contact Finder tool, since the
 * job here is identical: separate a real, reachable business address from
 * noise, image filenames and tracking junk.
 */
...
export function scoreEmail(hit, opts = {}) {
    ...
    if (hit.source === 'projectStory') {
        score += 25;
        reasons.push('written directly in the project story or description');
    }
